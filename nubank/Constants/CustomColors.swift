...
extension UIColor {
    ...
    static let nubankCardColor = #colorLiteral(red: 0.5848049521, green: 0.274792701, blue: 0.6747853756, alpha: 1)
    static let customGray = #colorLiteral(red: 0.968627451, green: 0.968627451, blue: 0.968627451, alpha: 1)
}
